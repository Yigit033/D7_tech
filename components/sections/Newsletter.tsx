  ...
  return (
    <section className="py-20 sm:py-28 bg-[#020409] relative overflow-hidden" aria-labelledby="connect-heading">
      ...
      <div className="relative max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <SectionLabel label="// FOLLOW OUR WORK" className="justify-center mb-6" />
          ...
          <p className="text-slate-400 text-sm sm:text-base max-w-md mx-auto leading-relaxed mb-10">
            We share updates on autonomous systems, sensing research, and field results as our work progresses. LinkedIn is the best place to follow along.
          </p>
